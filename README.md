...
![](https://img.shields.io/badge/Updated-August%232018-green.svg)

This repository contains the following tables and dataproducts from PISCO. 

Currently PISCO consists of **315** SNe in **269** galaxies and have run for **7** semesters (_Updated 2018 August 13_). However, data in this repo is for objects presented in the PISCO paper (272 SNe in 232 galaxies).
