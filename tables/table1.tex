...
\tablecaption{Details of the observing programs in CAHA dedicated to obtain PMAS/PPak IFS data of SN host galaxies (PI: Galbany/Domínguez). \label{tab:prop}}
...
\startdata
 ...
 19A & F18-3.5-008 & 4 nights  & - & Connecting SN Ia explosion mechanisms with the environment\\ 
\enddata
\end{deluxetable*}
